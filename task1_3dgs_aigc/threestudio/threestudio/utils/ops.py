...
from igl import fast_winding_number, point_mesh_squared_distance, read_triangle_mesh

def fast_winding_number_for_meshes(v, f, q):
    return fast_winding_number(v, f, q)

def read_obj(path, dtype):
    v, f = read_triangle_mesh(path)
    return v.astype(dtype), None, None, f, None, None
